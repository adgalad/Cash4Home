...
var checkImages = function() {
  ...
  if ($('#file1').val() == '') {
    ...
    $('#img_file1').attr('style', 'border: 1px solid gray;')
  }
  
  if ($('#file2').val() == ''){
    $('#img_file2').attr('style', 'border: 1px solid red;')
    return false
  } else {
    $('#img_file2').attr('style', 'border: 1px solid gray;')
  }
  
  if ($('#file3').val() == ''){
    $('#img_file3').attr('style', 'border: 1px solid red;')
    return false
  } else {
...
function SmartWizard (target, options) {
  ...
  var _adjustButton = function ($this) {
    if (!$this.options.cycleSteps) {
      ...
      if (($this.steps.length - 1) <= $this.curStepIdx) {
        ...
        // Finish Button
    // console.log($this.curStepIdx, $this.curStepIdx == 3)
    if (false) {
  ...
  SmartWizard.prototype.goForward = function () {
    ...
    $('img[class="imageUpload"]').attr('style', 'border: 1px solid gray;')
    _loadContent(this, nextStepIdx)
  }

...
urlpatterns = [
    ...
    url(r'^v1/login/', views.login, name='login'), # No poner $ al final de la regex
    ...
    url(r'^v1/account/new', views.createAccount, name='createAccount'), # No poner $ al final de la regex
